...
/**
 * Elevator subsystem -- 2-stage single-mast elevator, spring-assisted extension,
 * motor+rope retraction. No encoder on the lift motor (brushed, no built-in sensor);
